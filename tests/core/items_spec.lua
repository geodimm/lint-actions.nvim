...
describe('Action items', function()
  describe('matching by line', function()
  ...
  describe('matching by kind', function()
    for _, case in ipairs({
      ...
      {
        name = 'prefix needs a dot boundary',
        kind = 'source.fixAllExtra',
        only = { 'source.fixAll' },
        matches = false,
      },
  ...
  describe('validation', function()
    it('accepts optional ranges, columns, and action payloads without mutation', function()
      local candidates = {
    ...
    for _, case in ipairs({
      ...
      it('requires a valid ' .. case.name, function()
  ...
  describe('sorting', function()
    it('orders titles in place, preserves every payload, and is idempotent', function()
