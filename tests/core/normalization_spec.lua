...
describe('Action normalization', function()
  ...
  describe('current-document edits', function()
    for _, form in ipairs({ 'single edit', 'edit list', 'changes', 'documentChanges' }) do
      it(form .. ' becomes a versioned document edit without mutating its input', function()
  ...
  describe('workspace edits', function()
    it('preserves explicit secondary versions and resource operations', function()
    ...
    it('uses the running Neovim representation for unknown secondary versions', function()
    ...
    it('combines changes and documentChanges without losing annotations', function()
  ...
  describe('item ranges and payloads', function()
    it('defaults omitted ranges to the buffer and omitted columns to zero', function()
    ...
    it('copies command-only actions without adding an edit', function()
