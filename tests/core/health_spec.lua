...
describe('Health checks', function()
  ...
  describe('check()', function()
    it('reports the Neovim requirement', function()
      eq(find(run_check(), 'Neovim 0.11 or newer').level, 'ok')
    end)

    it('says so when nothing is attached or registered', function()
    ...
    it('reports the filetypes an attached linter runs on', function()
    ...
    it('warns about a linter no filetype runs', function()
    ...
    it('warns about a linter nvim-lint does not know', function()
      mock_nvim_lint({}, {})
    ...
    it('warns about a missing executable', function()
    ...
    it('lists registered providers', function()
