...
describe('Public API', function()
  ...
  describe('setup()', function()
    ...
    it('enables integrations with defaults or options', function()
      local calls = {}
    ...
    it('can attach integrations on a later call', function()
      local calls = 0
    ...
    it('ignores explicitly disabled integrations', function()
      local calls = 0
      mock_integration('golangci', function()
        calls = calls + 1
      end)
    ...
    it('rejects invalid options and integrations', function()
      local calls = 0
      mock_integration('golangci', function()
        calls = calls + 1
      end)
  ...
  describe('publish()', function()
    it('treats an empty publication as a source clear', function()
    ...
    for _, case in ipairs(invalid_publications) do
      local name, message, make_options = case[1], case[2], case[3]
      it(name, function()
  ...
  describe('clear()', function()
    it('validates its options', function()
  ...
  describe('ingest()', function()
    it('passes adapter context and uses the adapter source', function()
    ...
    it('rejects invalid adapters and invalid parser results', function()
