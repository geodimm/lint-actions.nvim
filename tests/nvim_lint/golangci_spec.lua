...
describe('golangci-lint nvim-lint integration', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('integration.attach()', function()
    it('uses the default nvim-lint linter and bundled adapter', function()
    ...
    it('defers loading the default nvim-lint linter', function()
      local lookups = 0
    ...
    it('accepts a concrete linter and source override', function()
