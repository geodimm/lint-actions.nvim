...
describe('markdownlint nvim-lint integration', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('integration.attach()', function()
    it('enables JSON and publishes actions from a concrete linter', function()
    ...
    it('resolves and configures factory linters by name once', function()
    ...
    it('rejects invalid options and linter definitions', function()
    ...
    it('does not duplicate an existing JSON argument', function()
      helpers.mock_nvim_lint({})
      local definition = linter()
