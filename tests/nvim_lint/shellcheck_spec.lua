...
describe('ShellCheck nvim-lint integration', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('integration.attach()', function()
    it('publishes actions from a concrete linter', function()
    ...
    it('resolves factory linters by name once', function()
