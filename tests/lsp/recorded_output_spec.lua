...
describe('Recorded tool output over LSP', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('recorded tool output', function()
    for _, tool in ipairs({ 'shellcheck', 'markdownlint' }) do
      it(tool .. ' fixes the buffer exactly as the tool does', function()
    ...
    it('golangci-lint exposes and applies a selected suggestion', function()
