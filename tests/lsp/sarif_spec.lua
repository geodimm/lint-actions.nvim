...
describe('SARIF code actions', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('SARIF fixes', function()
    it('ingests, filters, sorts, and applies Unicode alternatives', function()
    ...
    for _, update_primary in ipairs({ false, true }) do
      ...
      it('ingests and applies a fix targeting ' .. target, function()
