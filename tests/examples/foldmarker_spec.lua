...
describe('Fold marker provider example', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('examples/foldmarker.lua', function()
    it('offers a modeline for a buffer using fold markers', function()
    ...
    it('stays quiet without fold markers or without a commentstring', function()
    ...
    it('honours an existing modeline only where Vim would', function()
