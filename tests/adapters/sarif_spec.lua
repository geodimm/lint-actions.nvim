...
describe('SARIF adapter', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('parse()', function()
    it('creates a quick fix from a described SARIF fix', function()
    ...
    it('keeps alternative fixes as separate actions', function()
    ...
    it('converts both SARIF column units to UTF-8 positions', function()
    ...
    it('supports character offsets and DOS newline sequences', function()
    ...
    it('applies ordered replacements as one edit', function()
    ...
    it('resolves URI bases, escaped paths, and artifact indices', function()
    ...
    it('creates one workspace edit for a multi-artifact fix', function()
    ...
    it('offers a locationless result only to a buffer changed by the fix', function()
    ...
    it('drops a multi-artifact fix when another loaded buffer is modified', function()
    ...
    it('drops incomplete, binary, overlapping, remote, and unrelated fixes', function()
    ...
    it('ignores empty, malformed, and fixless output', function()
