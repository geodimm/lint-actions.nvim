...
describe('ShellCheck adapter', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('parse()', function()
    it('quotes an expansion with both halves of one fix', function()
    ...
    it('orders replacements at one point by precedence', function()
    ...
    it('rewrites a fix that spans several lines', function()
    ...
    it('converts character columns into byte positions', function()
    ...
    it('builds a whole-file fix that drops colliding fixes', function()
    ...
    it('ignores comments about other files', function()
    ...
    it('skips a fix whose replacements cannot all be resolved', function()
    ...
    it('ignores empty, invalid, and fixless output', function()
