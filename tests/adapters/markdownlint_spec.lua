...
describe('markdownlint adapter', function()
  before_each(helpers.reset)
  after_each(helpers.reset)

  describe('diagnostics()', function()
    it('parses messages, codes, and UTF-16 ranges', function()
    ...
    it('ignores empty, invalid, and non-array output', function()
  ...
  describe('parse()', function()
    it('creates a quick fix for one diagnostic', function()
    ...
    it('creates a whole-file fix with markdownlint overlap handling', function()
    ...
    it('targets UTF-16 fix columns with UTF-8 LSP positions', function()
    ...
    it('omits malformed and non-fixable issues', function()
