...
--
-- A complete lint-actions provider. Its action is derived from buffer content
-- rather than from a tool's output, so it is registered and asked on demand
-- instead of publishing ahead of time: no autocmds, no debouncing, and nothing
-- to invalidate when the buffer changes.
--
-- Copy this file into your config and call `setup()`.
